...
public class Administration_office extends JFrame implements Observer, ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == statusSearch) {
			if (lnkPermit_list.checkNameExists(statusPermitHolder.getText())) {// gets the information entered and
																				// checks to see if its a valid name.
				statusInfo.setText(lnkPermit_list.getPermit(statusPermitHolder.getText()).status());// gets the status
																									// information
																									// relating to the
																									// holders name and
																									// displays .
				...
				statusPermitHolder.setBorder(border);
			}
		}
...
//		System.out.println("thirdPanel");
	...
	public void setStatusPanel() {
		...
		// creating the layout and all panels for status panel
	...
	public void setModifyPermitPanel() {
		// creating the layout and all panels for modify panel
