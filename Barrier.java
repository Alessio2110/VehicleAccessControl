		...
		if (e.getSource() == checkRegNo) {
			...
			if (lnkVehicle_list.isRegistered(regNo)) {
				...
				if (v.getPermit().isAllowed(v, lnkSystem_status.getDate())) {
					...
					allowed = true;
					JOptionPane.showMessageDialog(null, "Vehicle Allowed! Please, pass and clear the vehicle.");
					lnkSystem_status.addLog("Date: " + today.getDay() + " RegNo: " + v.getRegNo()+ " Succesful\n");
				}
				else {
					JOptionPane.showMessageDialog(null, "Vehicle Not Allowed!");
					lnkSystem_status.addLog("Date: " + today.getDay() + " RegNo: " + regNo + " Unsuccesful\n");
				}
			}
